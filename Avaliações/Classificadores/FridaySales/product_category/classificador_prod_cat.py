...
pickle.dump(scaler, open('product_category/normalizador_num.pkl', 'wb'))
...
pickle.dump(dict_encoders, open('product_category/normalizador_cat_ord.pkl', 'wb'))
...
pickle.dump(X_train_nom.columns.to_list(), open('product_category/normalizador_cat_nom.pkl', 'wb'))
...
pickle.dump(best_rf, open('product_category/modelo_rf.pkl', 'wb'))
