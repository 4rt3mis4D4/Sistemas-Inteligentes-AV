...
# -- Divisão treino/teste via StratifiedKFold (mantém proporção das classes, sem train_test_split)
# -- Usa apenas o primeiro fold: 80% treino, 20% teste
...
pickle.dump(scaler, open('normalizador_num.pkl', 'wb'))
...
pickle.dump(X_train_nom.columns.to_list(), open('normalizador_cat_nom.pkl', 'wb'))
...
pickle.dump(best_rf, open('modelo_rf.pkl', 'wb'))
