...
pickle.dump(scaler, open('age_group/normalizador_num.pkl', 'wb'))
...
pickle.dump(X_train_nom.columns.to_list(), open('age_group/normalizador_cat_nom.pkl', 'wb'))

# -- Concatenação
X_train_final = pd.concat([X_train_num, X_train_nom], axis=1)
X_test_final = pd.concat([X_test_num, X_test_nom], axis=1)
...
pickle.dump(best_rf, open('age_group/modelo_rf.pkl', 'wb'))
